class Book:
   ...
   def __str__(self):
       ...
       return f'Название: {self.title}, Автор: {self.author}, страниц: {self.pages}, материал: {self.material} {reserve_status}'


book1 = Book('Идиот', 'Достоевский', 500, '123-4567890123')
